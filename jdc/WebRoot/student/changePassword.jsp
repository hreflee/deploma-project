...
<script type="text/javascript">
	function isValid(form) {
		...
		if (password.length < 6)//判定密码是否少于6位
		{
			msg += "您的新密码不能少于6位！\n";
			form.password.focus();
			alert(msg);
		...
		if (password2.length < 6)//判定密码是否少于6位
		{
			msg += "您再次输入密码不能少于6位！\n";
			form.password.focus();
			alert(msg);
...
<body bgcolor="#DFFFBF">
	<h3>修改密码</h3>
	<button id='back' type="button" onclick="javascript:window.location.href='../student/main.jsp'" class="button gray">返回 </button>
		...
		<table>
			...
			<tr>
				...
				<td><input  type="hidden"
					id="userType" name="userType" value="0">
					</td>
			</tr>
		</table>
	</form>
