...
<%
	...
	String cataName = new String(request.getParameter("cataName").getBytes("ISO-8859-1"),"utf-8");	
...
<body bgcolor="#DFFFBF">
	...
	<h3>
		当前用户：<%=studentname %>
		预习<%= new String(request.getParameter("cataName").getBytes("ISO-8859-1"),"utf-8") %>
